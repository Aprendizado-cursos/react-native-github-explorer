...
import { Container, AddGithubRepo, Title, Input, InputField, InputButton, Icon, RepositoriesList } from "./styles";
            ...
            <Container>
                <AddGithubRepo>
                    ...
                    <Input>
                        ...
                        <InputButton testID="input-button" onPress={handleAddRepository} disabled={!inputText}>
